...
$userpic=md5($upic).$extension;
    ...
    move_uploaded_file($_FILES["userpic"]["tmp_name"],"../user/userimages/".$userpic);

	
   $query=mysqli_query($con, "update tblstudentapplications set UserPic='$userpic' where Id='$cid'");
    if ($query) {
    $msg="Details  has been updated.";
	$msg = "update tblstudentapplications set UserPic='$userpic' where Id='$cid'";
  }
  else
    {
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Studnet Form</h4>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Student Photo(*)                   </h5>
<input class="form-control white_bg" id="userpic" name="userpic" type="file" >
</fieldset>                  
</div>
 </div>               
