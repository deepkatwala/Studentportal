...
body {
  -webkit-print-color-adjust: exact !important;
	...
	<body>
	    <?php echo $row[FirstName] ?> -><?php echo $row[LastName] ?>-> <?php echo $row[StudentClass] ?>-> <?php echo $row[RollNo] ?>
	   <div id="background" style="left: 0px;top: 150px;position: relative;margin-left: 250px; margin-right: auto; width: 308px; height: 511px;overflow: hidden; z-index: 0;">
