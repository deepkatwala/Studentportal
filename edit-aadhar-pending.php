...
move_uploaded_file($_FILES["acimage"]["tmp_name"],"../user/userdocs/aadhardoc/".$tc);




	
   $query=mysqli_query($con, "update tbladmapplications set aadhardoc='$tc' where ID='$cid'");
    if ($query) {
    $msg="Details  has been updated.";
	$msg = "update tbladmapplications set aadhardoc='$tc' where ID='$cid'";
  }
  else
    {
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Aadhar card                   </h5>
<input class="form-control white_bg" id="acimage" name="acimage" type="file" >
</fieldset>                  
</div>
 </div>               
