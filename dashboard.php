              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
<?php 
$ter =mysqli_query($con ,"SELECT ID from tblstudentapplications");
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
<?php 
$rtp =mysqli_query($con ,"SELECT ID from tblstudentapplications where AdminStatus is null");
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
<?php 
$yui =mysqli_query($con ,"SELECT ID from tblstudentapplications where AdminStatus='1'");
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
<?php 
$poi =mysqli_query($con ,"SELECT ID from tblstudentapplications where AdminStatus='2'");
