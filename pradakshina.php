...
<?php
//$cid=$_GET['aticid'];
$ret=mysqli_query($con,"select tblstudentapplications.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Email from tblstudentapplications inner join tbluser on tbluser.ID= tblstudentapplications.UserId where  tblstudentapplications.Studentclass='PRADAKSHINA'");
$cnt=1;
$id = mysqli_query($con	,"Select count(id) from tblstudentapplications where studentclass='PRADAKSHINA'");
...
body {
  -webkit-print-color-adjust: exact !important;
	...
	<?php echo $row['FirstName']; ?> -> <?php echo $row ['LastName']; ?> -> <?php echo $row['RollNo'];?>
	   ...
	   <div id="background" style="left: 0px;top:0px;position: relative;margin-left: 250px; margin-right: auto; width: 308px; height: 511px;overflow: hidden; z-index: 0;padding-bottom:50px">
